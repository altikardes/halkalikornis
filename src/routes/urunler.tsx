...
const productCategories = [
  {
    ...
    products: [
      {
        name: 'Zebra Perde',
        desc: 'Hem dekoratif hem de kullanışlı yapısıyla, gündüz ışığını yönetmenizi ve gece tam mahremiyet sağlamanızı kolaylaştıran modern çizgili perdeler.',
      },
      {
        name: 'Stor Perde',
        desc: 'Sade ve şık alanlar için ideal; tek bir mekanizmayla çalışan, ofis ve ev uyumlu, leke tutmaz ve kolay temizlenebilen stor sistemleri.',
      },
      {
        name: 'Tül Perde',
        desc: 'Odanıza doğal gün ışığını en iyi şekilde alarak ferahlık katan, farklı doku ve desenlerde pileli veya düz dikim zarif tüller.',
      },
      {
        name: 'Fon Perde',
        desc: 'İç mekan dekorasyonunu zenginleştiren, kalın dokusuyla ısı ve ışık yalıtımı sağlayarak ortamın kalitesini artıran tamamlayıcı perdeler.',
      },
    ],
  },
  {
    ...
    products: [
      ...
      { name: 'Dikey Jaluzi', desc: 'Geniş cepheli pencereler, boydan boya camlar ve toplantı odaları için güneşi en pratik şekilde yönetme imkanı sunar.' },
      { name: 'Bambu Jaluzi', desc: 'Hafif dokusu, çevre dostu malzemesi ve doğal görünümüyle daha rustik ve rahatlatıcı dekorasyonlar arayanlara hitap eder.' },
    ],
  },
  {
    ...
    products: [
      ...
      { name: 'PVC Çoklu Korniş', desc: 'Tül, güneşlik ve fon perdeleri bir arada asmak için en sık tercih edilen, ekonomik, pratik ve esnek kullanım sağlayan sistemler.' },
      { name: 'Özel Ölçü Tavan Çözümleri', desc: 'Alçıpan veya asma tavanlara zarar vermeden, malzemenin yapısına özel dübellerle uygulanan yüksek taşıma kapasiteli gizli raylar.' },
    ],
  },
]
    ...
    <div className="bg-slate-50/50 selection:bg-blue-200 selection:text-blue-900">
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1A2E4A] to-[#2c4b7c] px-4 py-16 text-white md:py-24">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h1 className="mb-6 text-4xl font-extrabold tracking-tight leading-tight md:text-5xl lg:text-6xl">Perde ve Korniş Çözümleri</h1>
          <p className="max-w-2xl mx-auto text-base leading-relaxed text-blue-100/90 md:text-lg">
            Hizmet odaklı yaklaşımımızla ev ve iş yeriniz için doğru çözümü belirliyor, modern ürün yelpazemiz ve garantili montaj hizmetimizle yaşam alanlarınıza değer katıyoruz.
          </p>
        </div>
      </section>
      ...
      <div className="px-4 py-16 md:py-20">
        <div className="max-w-6xl mx-auto">
          {productCategories.map((cat) => (
            <section key={cat.name} className="mb-16 rounded-[2rem] bg-white overflow-hidden shadow-xl shadow-slate-200/40 border border-slate-100 transition-all">
              <div className="h-64 md:h-80 relative overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/70 via-slate-900/20 to-transparent z-10 transition-colors group-hover:bg-slate-900/30" />
                ...
                <div className="absolute bottom-6 left-6 md:left-10 z-20">
                  <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">{cat.name}</h2>
                </div>
              </div>
              <div className="p-6 md:p-10">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {cat.products.map((p) => (
                    <div key={p.name} className="rounded-2xl bg-slate-50/50 p-6 border border-slate-100 transition-all hover:-translate-y-1 hover:shadow-md hover:border-blue-200 hover:bg-blue-50/30">
      ...
      <section className="px-4 pb-16 md:pb-20">
        <div className="mx-auto max-w-5xl rounded-[2.5rem] bg-gradient-to-br from-[#1A2E4A] to-[#2c4b7c] px-6 py-14 text-center text-white shadow-2xl md:px-12 md:py-16">
          <h2 className="mb-4 text-3xl font-extrabold tracking-tight md:text-4xl">Hangi Ürün Size Uygun?</h2>
          <p className="mx-auto mb-8 max-w-2xl text-base leading-relaxed text-blue-100/90 md:text-lg">
            Ücretsiz keşif ile evinize veya ofisinize en çok yakışacak ürün seçimini birlikte yapalım, aynı gün profesyonel montaj ile yaşam alanlarınızı yenileyelim.
          </p>
          <div className="flex flex-col justify-center gap-4 sm:flex-row">
            <a
              href="https://wa.me/905309264830?text=Merhaba%20korni%C5%9F%20montaj%C4%B1%20ve%20%C3%BCr%C3%BCnler%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum"
              target="_blank"
